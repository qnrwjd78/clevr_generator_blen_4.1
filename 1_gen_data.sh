...
echo $start
"$blender_path"/blender --background --python render_clevr.py -- --width 320 --height 240 --num_images 10 --output_image_dir "$out_folder/images/" --output_scene_dir "$out_folder/scenes/" --output_scene_file "$out_folder/CLEVR_scenes.json" --start_idx $start --use_gpu 0 --mode "$mode" --min_dist 0.1 --margin 0.1 --max_objects 1 --min_objects 1
done
